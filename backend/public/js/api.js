...
function renderBottomNav(activePage) {
  ...
  const user = Api.user();
  el.innerHTML = `
    <a href="chats.html" class="nav-item ${activePage === 'chats' ? 'active' : ''}"><span class="nav-icon">💬</span>Chats</a>
    <a href="feed.html" class="nav-item ${activePage === 'feed' ? 'active' : ''}"><span class="nav-icon">▶</span>For You</a>
    <a href="new-post.html" class="nav-item ${activePage === 'post' ? 'active' : ''}"><span class="nav-icon">＋</span>Post</a>
    <a href="profile.html?handle=${user?.handle || ''}" class="nav-item ${activePage === 'profile' ? 'active' : ''}"><span class="nav-icon">👤</span>Profile</a>
  `;
}
